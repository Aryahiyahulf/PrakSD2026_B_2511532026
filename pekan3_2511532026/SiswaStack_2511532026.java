...
public class SiswaStack_2511532026 {
    private ArrayList<Siswa> stack;


    public SiswaStack_2511532026() {
        stack = new ArrayList<>();
    }
    ...
    public static void main(String[] args) {
        SiswaStack_2511532026 studentStack = new SiswaStack_2511532026();

        Siswa mhs1 = new Siswa("Ary", 1);
        Siswa mhs2 = new Siswa("ataking", 2);
        Siswa mhs3 = new Siswa("oerel", 3);
